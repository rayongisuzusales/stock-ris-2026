  ...
  return (
    <aside className="sidebar" style={styles.aside}>
      <div style={styles.logo}>
        <div style={styles.logoMark}><span style={styles.logoI}>I</span></div>
        <div>
...
const styles = {
  ...
  logo:     { display:'flex', alignItems:'center', gap:10, padding:'20px 16px 16px' },
  logoMark: { width:32, height:32, background:'#CC0000', borderRadius:6,
              display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 },
  logoI:    { color:'#fff', fontWeight:700, fontSize:17 },
  ...
  divider:  { height:1, background:'#1A1A1A', margin:'0 12px 12px' },
  nav:      { flex:1, display:'flex', flexDirection:'column', gap:2, padding:'0 8px' },
  navBtn:   { display:'flex', alignItems:'center', gap:10, padding:'8px 10px', borderRadius:7,
              border:'none', background:'transparent', color:'#777', fontSize:13,
              cursor:'pointer', transition:'all .15s', width:'100%' },
  navActive:{ background:'#CC000012', color:'#F0F0F0', border:'1px solid #CC000025' },
  footer:   { padding:'12px 16px 20px', display:'flex', alignItems:'center', gap:8,
